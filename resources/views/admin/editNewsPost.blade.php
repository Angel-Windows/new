...
{{--                                {!! Form::text("{$locale}[name]",   $post->translate($locale)->name, array('class'=>'form-control') ) !!}--}}
                    ...
                    @foreach(config('translatable.locales') as $locale)
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
{{--                                {!! Form::textarea("{{$locale}[description]}",  $post->translate($locale)->description, array('class'=>'form-control') ) !!}--}}
...
{{--                                {!! Form::textarea("{{$locale}[body]}",  $post->translate($locale)->body, array('class'=>'form-control editor') ) !!}--}}
        ...
        <div class="tab-pane" id="tab_b">
            {{--            <input type="text" class="form-control" id="inputSlug" name="" value="{{ $post->slug }}">--}}
            <div class="form-group">&nbsp;</div>
            <div class="form-group">
