                            ...
                            @foreach( $slider as $slide )
                                <div class="item">
                                    ...
                                    <div class="rightSliderText">
                                        ...
                                        <a href="{{$slide->link}}" class="more"> @if(empty($slide->textButton))
                                                {{trans('cosmetics.more')}}
                                            @else
                                                {{ $slide->textButton }}
                                            @endif</a>
                                    </div>
                    ...
                    <div class="items-block @if($catBlock1->gradient == 'green') green @endif @if($catBlock1->gradient == 'yellow') yellow @endif col-xs-12">
                        <div class="row">
                            <div class="catBlock col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <div class="category">
                                    <img src="/uploads/category/<?php echo !empty($catBlock1->image) ? $catBlock1->image : 'no_image.png'?>"
                                         alt="#">
                                    <div class="blockInfo">
                                        <div class="title">{{ $catBlock1->name }}</div>
                                        <div class="description">{{ substr(strip_tags($catBlock1->body), 0 , 180).'...' }}</div>
                                        <div class="button">
                                            <a href="/category/{{ $catBlock1->slug }}">
                                                {{trans('cosmetics.show_catalog')}}
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="item  @if($catBlock1Product->discount == 1) discount @endif @if($catBlock1Product->new == 1) new @endif @if($catBlock1Product->sale == 1) sale @endif ">
                                                <div class="image">
                                                    @if( $catBlock1Product->image !='')
                                                        <img src="/uploads/products/md/{{ $catBlock1Product->image }}"
                                                             alt="{{ $catBlock1Product->name }}">
                                                    @else
                                                ...
                                                <div class="information">
                                                    ...
                                                    <div class="prices">
                                                        ...
                                                        @endif
                                                        <div class="now">
                                                            <span>{{ number_format($catBlock1Product->price - ($catBlock1Product->price * $userDiscount), 2, ',', '') }}</span>
                                                            Грн
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                                                    @include('partials.characteristics', ['prod' => $catBlock1Product])--}}
                                            ...
                                            <div class="item @if($catBlock2Product->discount == 1) discount @endif @if($catBlock2Product->new == 1) new @endif @if($catBlock2Product->sale == 1) sale @endif">
                                                <div class="image">
                                                    @if( $catBlock2Product->image !='')
                                                        <img src="/uploads/products/md/{{ $catBlock2Product->image }}"
                                                             alt="{{ $catBlock2Product->name }}">
                                                    @else
                                                        <img src="{{asset('uploads/products/md/no_image.png')}}"
                                                             alt="#">
                                                    @endif
                                                ...
                                                <div class="information">
                                                    ...
                                                    <div class="prices">
                                                        ...
                                                        @endif
                                                        <div class="now">
                                                            <span>{{ number_format($catBlock2Product->price - ($catBlock2Product->price * $userDiscount), 2, ',', '') }}</span>
                                                            Грн
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                                                    @include('partials.characteristics', ['prod' => $catBlock2Product])--}}
                            ...
                            <div class="catBlock col-lg-3 col-md-12 col-sm-12 col-xs-12" id="greenCat">
                                <div class="category">
                                    <img src="/uploads/category/<?php echo !empty($catBlock2->image) ? $catBlock2->image : 'no_image.png'?>"
                                         alt="#">
                                    <div class="blockInfo">
                                        <div class="title">{{ $catBlock2->name }}</div>
                                        <div class="description">{{ substr(strip_tags($catBlock2->body), 0 , 180).'...' }}</div>
                                        <div class="button">
                                            <a href="/category/{{ $catBlock2->slug }}">
                                                {{trans('cosmetics.show_catalog')}}
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="items-block @if($catBlock3->gradient == 'green') green @endif @if($catBlock3->gradient == 'yellow') yellow @endif col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <div class="catBlock col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <div class="category">
                                    <img src="/uploads/category/<?php echo !empty($catBlock3->image) ? $catBlock3->image : 'no_image.png'?>"
                                         alt="#">
                                    <div class="blockInfo">
                                        <div class="title">{{ $catBlock3->name }}</div>
                                        <div class="description">{{ substr(strip_tags($catBlock3->body), 0 , 145).'...' }}</div>
                                        <div class="button">
                                            <a href="/category/{{ $catBlock3->slug }}">
                                                {{trans('cosmetics.show_catalog')}}
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="item @if($catBlock3Product->discount == 1) discount @endif @if($catBlock3Product->new == 1) new @endif @if($catBlock3Product->sale == 1) sale @endif">
                                                <div class="image">
                                                    @if( $catBlock3Product->image !='')
                                                        <img src="/uploads/products/md/{{ $catBlock3Product->image }}"
                                                             alt="{{ $catBlock3Product->name }}">
                                                    @else
                                                        <img src="{{asset('uploads/products/md/no_image.png')}}"
                                                             alt="#">
                                                    @endif
                                                ...
                                                <div class="information">
                                                    ...
                                                    <div class="prices">
                                                        ...
                                                        <div class="now">
                                                            <span>{{ number_format($catBlock3Product->price - ($catBlock3Product->price * $userDiscount), 2, ',', '') }}</span>
                                                            Грн
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                                                    @include('partials.characteristics', ['prod' => $catBlock3Product])--}}
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="row">
                                    ...
                                    <div class="slide">
                                        <div class="image">
                                            <div class="smParentImage">
                                                ...
                                                <img src="/uploads/news/<?php echo !empty($item->image) ? $item->image : 'no_image.png'?>"
                                                     alt="#">
                                            </div>
                                        </div>
                                        <div class="news-content">
                                            <div class="content">
                                                ...
                                                <a href="/news/{{ $item->slug }}"
                                                   class="more">{{trans('cosmetics.more')}}</a>
                                            </div>
                                        </div>
                        ...
                        <a class="moreNews" href="/news">{{trans('cosmetics.more_news')}}</a>
                    </div>
                </div>
            </div>
        </div>
