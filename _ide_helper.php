 ...
 * Generated for Laravel 5.1.46 (LTS) on 2022-09-24 21:45:47.
 *
...
namespace Illuminate\Html { 
    ...
    class HtmlFacade {
        ...
        {
            return \Illuminate\Html\HtmlBuilder::pages($data);
        }
         ...
         * @static 
         */ 
        public static function cat_tree($data, $selected_category, $level = 0, $nbsp = '')
        {
            return \Illuminate\Html\HtmlBuilder::cat_tree($data, $selected_category, $level, $nbsp);
        }
...
namespace App\Facade { 
    ...
    class TranslateBranch {
         ...
         * @static 
         */ 
        public static function getTranslateText($text, $lang)
        {
            return \App\Services\Translation\TranslationService::getTranslateText($text, $lang);
        }
         ...
         * @static 
         */ 
        public static function getTranslateTextRu($text, $lang)
        {
            return \App\Services\Translation\TranslationService::getTranslateTextRu($text, $lang);
        }
...
namespace  { 
    ...
    class TranslateBranch extends \App\Facade\TranslateBranch {}
