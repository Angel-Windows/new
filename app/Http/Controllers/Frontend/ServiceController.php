...
class ServiceController extends BaseController
{
    public function getIndex()
    {
        ...
        $page = new Page;
        $page->name = trans('cosmetics.cabinet.service_request');
        $page->meta_title = trans('cosmetics.cabinet.service_request');
        $page->slug = 'service';
    ...
    public function postIndex(Request $request)
    {
        ...
        $post = Feedback::create([
            'title' => $request->get('title'), 'comment' => $request->get('text'), 'user_id' => $user->id
        ]);
